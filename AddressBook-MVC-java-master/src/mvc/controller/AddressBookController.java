    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String facebook = contactDetailsPanel.getFacebookField().getText();   
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
             person.setData(name,mobile,email,facebook);
   ...
   */
    ...
    public Boolean validate(){
        ...
        if(mobile.length()!=10 ||numeric == false){
            JOptionPane.showMessageDialog(new JFrame(), "enter proper mobile number","Inane error", JOptionPane.ERROR_MESSAGE);
            mobile = null;
        }
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setFacebook(detailPanel.getFacebookField().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getFacebookField().setEditable(false);
        }
    }  //loadPersons ends
